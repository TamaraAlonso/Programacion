...
public class ListadoDepartamentos extends javax.swing.JDialog {

 
    public ListadoDepartamentos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Listado por departamento");
        ...
        jLabel2.setText("Listado de empleados por departamento");
    ...
    private void cbDepartamentosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbDepartamentosActionPerformed
        taDatos.setText(Main.generarDatosListado("departamento", cbDepartamentos.getSelectedIndex()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoDepartamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListadoDepartamentos dialog = new ListadoDepartamentos(new javax.swing.JFrame(), true);
